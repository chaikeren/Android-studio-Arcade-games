...
public class LeaderBoard extends AppCompatActivity implements View.OnClickListener {
    ...
    Integer index = 0, idCurrentGame = R.id.colors_game_btn;
    String strCurrentGame = "colorsGame";
        ...
        eventListenerScores = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    Integer score = ds.child(strCurrentGame).getValue(Integer.class);
    ...
    private void showLeaderBoard(String game, int id){
        ...
        if(strCurrentGame != game){
            findViewById(id).setBackgroundColor(Color.parseColor("#FF6E6E"));

            findViewById(idCurrentGame).setBackgroundResource(R.color.light_blue);
