...
public class FingerMe extends AppCompatActivity implements View.OnClickListener {
    ...
    private void randomEvent(){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                myLayout.setBackgroundColor(getResources().getColor(R.color.sky_blue));
            }
        },3000);
    }
    ...
    private void startTimer() {
        /**
         * Show picture at a random time (10-60) sec
         */
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(time == randomTime){
                            randomEvent();
                            randomTime = random.nextInt(SECONDS + 1 - 10) + 10;
                        }
                    }
                });
            }
    ...
    private void exit(){
        ...
        startActivity(new Intent(FingerMe.this, HomePage.class));
    }
}